                    ...
                    <form onSubmit={handleSubmit} className="relative z-10 space-y-5">
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                required
                                className="w-full border border-slate-300 rounded-lg pl-10 pr-4 py-2.5 text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                required
                                className="w-full border border-slate-300 rounded-lg pl-10 pr-10 py-2.5 text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
