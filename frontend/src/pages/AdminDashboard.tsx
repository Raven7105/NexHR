import { Users, UserCheck, Calendar, AlertCircle, Cake, Check, X, Building2, UserX } from "lucide-react";
...
import { BarChart, Bar, XAxis, YAxis, CartesianGrid, ResponsiveContainer, Tooltip, LineChart, Legend, Line } from "recharts";
...
export default function AdminDashboardPage() {
    ...
    const presentToday =
        attendancesData?.filter((a) => a.statut === "present").length ?? 0;
    const absentToday =
        attendancesData?.filter((a) => a.statut === "absent").length ?? 0;
    ...
    return (
        <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-5 mb-7">
            ...
            <div className="bg-card border border-border rounded-xl p-5 mb-6">
                <h2 className="font-semibold text-foreground mb-4">Présence & Abscence (7 derniers jours) </h2>
